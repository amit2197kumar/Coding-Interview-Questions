/*
JAVA implementation on MIN-HEAP
...
public class MinHeap {
    ...
    MinHeap (int heapMaxSize) {
        this.heapMaxSize = heapMaxSize;
        this.heapCurrIndex = 0;
        heap = new int[heapMaxSize];

        // If Heap array start with 1, this.heapCurrIndex = 1; heap[0] = Integer.MIN_VALUE;
    }
    ...
    public static void main(String[] args) {
        ...
        MinHeap minHeap = new MinHeap(enterHeapMaxSize);

        while (true) {
            System.out.println("1. INSERT an element in MIN-HEAP");
            System.out.println("2. REMOVE an element from MIN-HEAP");
            System.out.println("3. DELETE an index(element) from MIN-HEAP Array");
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    int valueD  = minHeap.deleteIndex(index);
                    if (valueD != -1)
